(() => {
	...
	const e = window.React,
		...
		w = {
			name: "peach-payments",
			label: (0, e.createElement)((ctx) => {
				const { PaymentMethodLabel: PMLabel } = ctx.components;
				return (0, e.createElement)(PMLabel, {
					text: s,
					icon: c.icon
						? (0, e.createElement)("img", { src: c.icon, alt: "", style: { height: 22 } })
						: undefined
				});
			}, null),
